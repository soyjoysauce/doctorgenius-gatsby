...
class OutageForm extends React.Component {
  constructor(props) {
    super(props)
  ...
  handleFormSubmit(ev) {
    ...
    data.append("BusinessName", this.businessName.value)
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <label htmlFor="input-name">Website</label>
            <input
              ref={ref => {
                this.website = ref
              }}
          ...
          >
            <label htmlFor="input-name">Describe Incident or Outage</label>
            <input
              ref={ref => {
